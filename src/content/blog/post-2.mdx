...
<File title = "Web Component With ShadowDOM Repl.it Link" link = "https://replit.com/@smartebio/webcomponent"/>

<File title = "Web Component Without ShadowDOM Repl.it Link" link = "https://replit.com/@smartebio/webcomponent2"/>

**1.** First, create the file for the web component.

The file naming convention is to separate all words with dashes.
...
**2.** Now, in your html file import the component like so, 

<Prism lang="html" code={`  <script src="hello-world.js"></script>`} />

**3.** Now, you can use it as an HTML element like so,
...
# How to access the web component using JavaScript (Accessing Component Dynamically)
